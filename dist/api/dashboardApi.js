...
exports.DashboardApi = exports.DashboardApiApiKeys = void 0;
...
class DashboardApi {
    ...
    setApiKey(key, value) {
        this.authentications[DashboardApiApiKeys[key]].apiKey = value;
    }
    addInterceptor(interceptor) {
        this.interceptors.push(interceptor);
    }
    fetchDashboardActiveStaticVoucherCampaignsCount(startDateTime, endDateTime, options = { headers: {} }) {
    ...
    fetchDashboardWidgetsCatalog(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<DashboardWidget>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
