...
exports.GalleryApi = exports.GalleryApiApiKeys = void 0;
const request_1 = __importDefault(require("request"));
const models_1 = require("../model/models");
const models_2 = require("../model/models");
const apis_1 = require("./apis");
let defaultBasePath = 'https://api.wall.et';
var GalleryApiApiKeys;
(function (GalleryApiApiKeys) {
    GalleryApiApiKeys[GalleryApiApiKeys["api_key"] = 0] = "api_key";
})(GalleryApiApiKeys = exports.GalleryApiApiKeys || (exports.GalleryApiApiKeys = {}));
class GalleryApi {
    ...
    setApiKey(key, value) {
        this.authentications[GalleryApiApiKeys[key]].apiKey = value;
    }
    addInterceptor(interceptor) {
        this.interceptors.push(interceptor);
    }
    archiveImageGrid(id, options = { headers: {} }) {
                    ...
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "ImageGrid");
    ...
    createImageGrid(wTImageGridCreateParams, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(wTImageGridCreateParams, "WTImageGridCreateParams")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
    ...
    fetchAllImageGrid(isArchiveIncluded, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    restoreImageGrid(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/imageGrid/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
    ...
    updateImageGrid(id, wTImageGridUpdateParams, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/imageGrid/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(wTImageGridUpdateParams, "WTImageGridUpdateParams")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
