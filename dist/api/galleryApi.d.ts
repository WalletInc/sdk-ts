...
export declare enum GalleryApiApiKeys {
    api_key = 0
}
export declare class GalleryApi {
    ...
    setApiKey(key: GalleryApiApiKeys, value: string): void;
    addInterceptor(interceptor: Interceptor): void;
    archiveImageGrid(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    restoreImageGrid(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateImageGrid(id: string, wTImageGridUpdateParams: WTImageGridUpdateParams, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
