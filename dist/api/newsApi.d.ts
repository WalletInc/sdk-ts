...
export declare class NewsApi {
    ...
    archiveNewsArticle(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    restoreNewsArticle(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateNewsArticle(id: string, wTNewsArticleUpdateParams: WTNewsArticleUpdateParams, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
