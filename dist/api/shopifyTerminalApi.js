...
exports.ShopifyTerminalApi = exports.ShopifyTerminalApiApiKeys = void 0;
...
class ShopifyTerminalApi {
    ...
    setApiKey(key, value) {
        this.authentications[ShopifyTerminalApiApiKeys[key]].apiKey = value;
    }
    addInterceptor(interceptor) {
        this.interceptors.push(interceptor);
    }
    fetchWalletItemFromShopifyTerminal(itemID, options = { headers: {} }) {
    ...
    redeemWalletItemFromShopifyTerminal(itemID, wTWalletItemRedemption, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    refundWalletItemFromShopifyTerminal(ledgerEntryID, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.ShopifyTerminalApi = ShopifyTerminalApi;
//# sourceMappingURL=shopifyTerminalApi.js.map