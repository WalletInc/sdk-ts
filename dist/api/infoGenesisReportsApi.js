...
exports.InfoGenesisReportsApi = exports.InfoGenesisReportsApiApiKeys = void 0;
...
class InfoGenesisReportsApi {
    ...
    setApiKey(key, value) {
        this.authentications[InfoGenesisReportsApiApiKeys[key]].apiKey = value;
    }
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<Request>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<StaticVoucher>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    fetchInfoGenesisRedeemedUniquePostingIDs(startDateTime, endDateTime, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    fetchInfoGenesisRefundedRoutingIDs(startDateTime, endDateTime, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    fetchInfoGenesisRequest(transactionID, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Request");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    fetchInfoGenesisResponseErrors(startDateTime, endDateTime, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<Response>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
...
exports.InfoGenesisReportsApi = InfoGenesisReportsApi;
//# sourceMappingURL=infoGenesisReportsApi.js.map