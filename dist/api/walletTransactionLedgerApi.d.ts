...
export declare enum WalletTransactionLedgerApiApiKeys {
    api_key = 0
}
export declare class WalletTransactionLedgerApi {
    ...
    setApiKey(key: WalletTransactionLedgerApiApiKeys, value: string): void;
