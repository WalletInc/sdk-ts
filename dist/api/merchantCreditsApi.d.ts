...
export declare class MerchantCreditsApi {
    ...
    archiveMerchantCredit(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchMerchantCreditById(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    restoreMerchantCredit(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateMerchantCredit(id: string, pickWTMerchantCreditMemberIDOrCreditAmountOrMobileNumber: PickWTMerchantCreditMemberIDOrCreditAmountOrMobileNumber, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
