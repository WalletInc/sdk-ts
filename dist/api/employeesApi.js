...
})(EmployeesApiApiKeys || (exports.EmployeesApiApiKeys = EmployeesApiApiKeys = {}));
class EmployeesApi {
    ...
    createDocument(wTEmployeeCreateDocument, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(wTEmployeeCreateDocument, "WTEmployeeCreateDocument")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Document");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    deleteDocument(documentID, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    fetchDocuments(folder, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarFormParams = {};
            if (folder !== undefined) {
                localVarQueryParameters['folder'] = models_1.ObjectSerializer.serialize(folder, "string");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<Document>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    fetchMediaFiles(folder, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateClubMembers(wTEmployeeUpdateRecords, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(wTEmployeeUpdateRecords, "WTEmployeeUpdateRecords")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
    ...
    updateEmailNotificationPreference(inlineObject, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (inlineObject === null || inlineObject === undefined) {
                throw new Error('Required parameter inlineObject was null or undefined when calling updateEmailNotificationPreference.');
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
