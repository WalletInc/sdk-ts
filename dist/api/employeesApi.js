...
class EmployeesApi {
    ...
    fetchProfileInfo(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateChromeThemePreference(updateChromeThemePreferenceRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/employee/chromeThemePreference';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (updateChromeThemePreferenceRequest === null || updateChromeThemePreferenceRequest === undefined) {
                throw new Error('Required parameter updateChromeThemePreferenceRequest was null or undefined when calling updateChromeThemePreference.');
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(updateChromeThemePreferenceRequest, "UpdateChromeThemePreferenceRequest")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
    ...
    updateEmailNotificationPreference(updateEmailNotificationPreferenceRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(updateEmailNotificationPreferenceRequest, "UpdateEmailNotificationPreferenceRequest")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
    ...
    updatePageTipsPreference(updatePageTipsPreferenceRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/employee/pageTipsPreference';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (updatePageTipsPreferenceRequest === null || updatePageTipsPreferenceRequest === undefined) {
                throw new Error('Required parameter updatePageTipsPreferenceRequest was null or undefined when calling updatePageTipsPreference.');
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(updatePageTipsPreferenceRequest, "UpdatePageTipsPreferenceRequest")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
