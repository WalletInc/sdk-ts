...
export declare enum EmailSubscribersApiApiKeys {
    api_key = 0
}
export declare class EmailSubscribersApi {
    ...
    setApiKey(key: EmailSubscribersApiApiKeys, value: string): void;
    addInterceptor(interceptor: Interceptor): void;
    archiveEmailSubscriber(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    restoreEmailSubscriber(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateEmailSubscriber(id: string, wTEmailSubscriberUpdateParams: WTEmailSubscriberUpdateParams, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
