...
export declare class MembershipTiersApi {
    ...
    archiveMembershipTier(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchMembershipTierById(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateMembershipTier(id: string, wTMembershipTierUpdateParams: WTMembershipTierUpdateParams, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
