...
class MerchantApi {
    ...
    fetchHelpDeskRequests(phoneNumberID, isResolved, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<HelpDeskRequest>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    fetchMerchantPhoneNumbers(isArchiveIncluded, isApproved, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isApproved !== undefined) {
                localVarQueryParameters['isApproved'] = models_1.ObjectSerializer.serialize(isApproved, "boolean");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
    ...
    fetchPhoneNumber(phoneNumberID, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    fetchTCPAFilter(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateBillingContact(wTMerchantUpdateBillingContact, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(wTMerchantUpdateBillingContact, "WTMerchantUpdateBillingContact")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
