...
export declare class VirtualBusinessCardApi {
    ...
    archiveVirtualBusinessCard(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchVirtualBusinessCard(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchVirtualBusinessCardRequests(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    restoreVirtualBusinessCard(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateVirtualBusinessCard(id: string, wTVirtualBusinessCardUpdateParams: WTVirtualBusinessCardUpdateParams, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
