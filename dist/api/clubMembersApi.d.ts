...
export declare enum ClubMembersApiApiKeys {
    api_key = 0
}
export declare class ClubMembersApi {
    ...
    setApiKey(key: ClubMembersApiApiKeys, value: string): void;
    addInterceptor(interceptor: Interceptor): void;
    archiveMember(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchMemberById(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    restoreMember(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateMember(id: string, pickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday: PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
