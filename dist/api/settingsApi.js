...
(function (SettingsApiApiKeys) {
    SettingsApiApiKeys[SettingsApiApiKeys["api_key"] = 0] = "api_key";
...
class SettingsApi {
    ...
    getActiveCampaigns(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/settings/campaigns/active';
    ...
    getVouchersCount(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
