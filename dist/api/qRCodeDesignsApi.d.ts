...
export declare class QRCodeDesignsApi {
    ...
    archiveQRCodeDesign(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchQRCodeDesignById(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    restoreQRCodeDesign(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateQRCodeDesign(id: string, wTQRCodeDesignUpdateParams: WTQRCodeDesignUpdateParams, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
