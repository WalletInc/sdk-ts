...
exports.CountriesApi = exports.CountriesApiApiKeys = void 0;
...
(function (CountriesApiApiKeys) {
    CountriesApiApiKeys[CountriesApiApiKeys["api_key"] = 0] = "api_key";
...
class CountriesApi {
    ...
    fetchAllCountries(options = { headers: {} }) {
                    ...
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<FetchAllCountries200ResponseInner>");
