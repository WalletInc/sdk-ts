...
(function (AuthenticationApiApiKeys) {
    AuthenticationApiApiKeys[AuthenticationApiApiKeys["api_key"] = 0] = "api_key";
...
class AuthenticationApi {
    ...
    register(wTAuthenticationRegister, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(wTAuthenticationRegister, "WTAuthenticationRegister")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
