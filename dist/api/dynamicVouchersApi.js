...
class DynamicVouchersApi {
    ...
    archiveDynamicVoucherCampaign(campaignID, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/payment/dynamicVoucher/{campaignID}'
            ...
            if (campaignID === null || campaignID === undefined) {
                throw new Error('Required parameter campaignID was null or undefined when calling archiveDynamicVoucherCampaign.');
            }
    ...
    restoreDynamicVoucherCampaign(campaignID, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/payment/dynamicVoucher/{campaignID}'
                .replace('{' + 'campaignID' + '}', encodeURIComponent(String(campaignID)));
            let localVarQueryParameters = {};
            ...
            let localVarFormParams = {};
            if (campaignID === null || campaignID === undefined) {
                throw new Error('Required parameter campaignID was null or undefined when calling restoreDynamicVoucherCampaign.');
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
