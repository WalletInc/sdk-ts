...
export declare class StaticVouchersApi {
    ...
    deleteStaticVoucher(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchReachStatsOfIndividualStaticVoucher(staticVoucherID: string, broadcastScheduledStartAt?: Date, broadcastScheduledEndAt?: Date, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    fetchStaticVoucher(id: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateStaticVoucher(id: string, wTStaticVoucherUpdateParams: WTStaticVoucherUpdateParams, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
