...
})(AnalyticsApiApiKeys || (exports.AnalyticsApiApiKeys = AnalyticsApiApiKeys = {}));
class AnalyticsApi {
    ...
    countAllSubscribers(isSubscribed, isPendingAge21Verification, isArchiveIncluded, startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/sms/all/subscribers/count';
    ...
    countAuthenticatedSessions(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/walletPageViews/sessions/count/distinct/authenticated';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
    ...
    countDistinctRedemptions(startDate, endDate, transactionType, segmentType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/ledger/paymentObject/distinct/count';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling countDistinctRedemptions.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling countDistinctRedemptions.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
            ...
            if (transactionType !== undefined) {
                localVarQueryParameters['transactionType'] = models_1.ObjectSerializer.serialize(transactionType, "string");
            }
            if (segmentType !== undefined) {
                localVarQueryParameters['segmentType'] = models_1.ObjectSerializer.serialize(segmentType, "string");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
    ...
    countHelpDeskRequests(startDate, endDate, locale, timezone, isResolved, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/helpdeskrequests/count';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling countHelpDeskRequests.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling countHelpDeskRequests.');
            }
            if (locale === null || locale === undefined) {
                throw new Error('Required parameter locale was null or undefined when calling countHelpDeskRequests.');
            }
            if (timezone === null || timezone === undefined) {
                throw new Error('Required parameter timezone was null or undefined when calling countHelpDeskRequests.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
            ...
            if (isResolved !== undefined) {
                localVarQueryParameters['isResolved'] = models_1.ObjectSerializer.serialize(isResolved, "boolean");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
    ...
    countInboundMessages(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/sms/inbound/count';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
    ...
    countNewSessions(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/walletPageViews/sessions/count/distinct/first';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
    ...
    countOptInListSubscribersPartitionedByDate(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/sms/all/subscribers/count/date';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling countOptInListSubscribersPartitionedByDate.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling countOptInListSubscribersPartitionedByDate.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
    ...
    countOutboundMessages(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/sms/outbound/count';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
    ...
    countTotalSessions(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/walletPageViews/sessions/count/distinct';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
    ...
    countTransactions(startDate, endDate, transactionType, segmentType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/ledger/transactions/count';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling countTransactions.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling countTransactions.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
    ...
    fetchAnalyticsTCPAFiltersCreateCountPartitionedByDate(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/tcpafilters/count/date/create';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling fetchAnalyticsTCPAFiltersCreateCountPartitionedByDate.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling fetchAnalyticsTCPAFiltersCreateCountPartitionedByDate.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
    ...
    fetchAnalyticsTCPAFiltersDeleteCountPartitionedByDate(startDate, endDate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/tcpafilters/count/date/delete';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling fetchAnalyticsTCPAFiltersDeleteCountPartitionedByDate.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling fetchAnalyticsTCPAFiltersDeleteCountPartitionedByDate.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
    ...
    sumRevenue(startDate, endDate, transactionType, segmentType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarFormParams = {};
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling sumRevenue.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling sumRevenue.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
    ...
    sumTransactions(startDate, endDate, transactionType, segmentType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/v2/analytics/ledger/transactions/sum';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            if (produces.indexOf('application/json') >= 0) {
            ...
            let localVarFormParams = {};
            if (startDate === null || startDate === undefined) {
                throw new Error('Required parameter startDate was null or undefined when calling sumTransactions.');
            }
            if (endDate === null || endDate === undefined) {
                throw new Error('Required parameter endDate was null or undefined when calling sumTransactions.');
            }
            if (startDate !== undefined) {
                localVarQueryParameters['startDate'] = models_1.ObjectSerializer.serialize(startDate, "Date");
            }
