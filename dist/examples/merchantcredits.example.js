...
function merchantCredits() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(merchantcredit);
        merchantcredit = yield client.updateMerchantCredit(merchantcredit.id, Object.assign(Object.assign({}, merchantcredit), { creditAmount: 1000 }), constants.headers).catch(err => {
            throw err;
        }).then(resp => {
            return resp.body;
        });
