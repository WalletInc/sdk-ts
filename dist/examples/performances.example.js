...
function performances() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        performance = yield client.updatePerformance(performance.id, Object.assign(Object.assign({}, performance), { title: "performance Updated" }), constants.headers).catch(err => {
            throw err;
        }).then(resp => {
            return resp.body;
        });
