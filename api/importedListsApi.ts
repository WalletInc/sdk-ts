...
export class ImportedListsApi {
     ...
     * @param importedListID 
     * @param wTImportedListRecipientImport 
     */
    public async importImportedListRecipients (importedListID: string, wTImportedListRecipientImport: WTImportedListRecipientImport, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        ...
        // verify required parameter 'wTImportedListRecipientImport' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(wTImportedListRecipientImport, "WTImportedListRecipientImport")
        };
