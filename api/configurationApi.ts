...
export class ConfigurationApi {
     ...
     * @param inlineObject3 
     */
    public async saveMerchantCreditPaymentDesign (inlineObject3: InlineObject3, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
