...
export enum DashboardSummariesApiApiKeys {
    api_key,
}

export class DashboardSummariesApi {
    ...
    public setApiKey(key: DashboardSummariesApiApiKeys, value: string) {
        (this.authentications as any)[DashboardSummariesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param endDate 
     */
    public async countTotalWalletSessions (startDate?: Date, endDate?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTCountResult;  }> {
     ...
     * @param endDateTime 
     */
    public async fetchSubscriberCount (startDateTime: Date, endDateTime: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTCountResult;  }> {
