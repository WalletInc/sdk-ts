...
export enum WalletMobileTerminalApiApiKeys {
    api_key,
}

export class WalletMobileTerminalApi {
    ...
    public setApiKey(key: WalletMobileTerminalApiApiKeys, value: string) {
        (this.authentications as any)[WalletMobileTerminalApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * 
     * @summary Search for Member\'s rewards
     * @param memberID 
     */
