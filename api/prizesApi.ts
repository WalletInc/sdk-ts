...
export class PrizesApi {
    ...
    public setApiKey(key: PrizesApiApiKeys, value: string) {
        (this.authentications as any)[PrizesApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * 
     * @summary Archive Prize
     * @param id 
     */
    public async archiveAdvertisementCredit (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTAdvertisementCredit;  }> {
     ...
     * @param id 
     */
    public async fetchAdvertisementCreditById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTAdvertisementCredit;  }> {
        const localVarPath = this.basePath + '/v2/payment/advertisementCredit/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    /**
     * 
     * @summary Get Prizes awarded
     * @param id 
     */
    public async fetchAdvertisementCreditScans (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<WTAdvertisementCreditScan>;  }> {
     ...
     * @param id 
     */
    public async restoreAdvertisementCredit (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTAdvertisementCredit;  }> {
        const localVarPath = this.basePath + '/v2/payment/advertisementCredit/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async updateAdvertisementCredit (id: string, wTAdvertisementCreditUpdateParams: WTAdvertisementCreditUpdateParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTAdvertisementCredit;  }> {
        const localVarPath = this.basePath + '/v2/payment/advertisementCredit/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
