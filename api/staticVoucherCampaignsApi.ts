...
export class StaticVoucherCampaignsApi {
     ...
     * @param campaignID 
     */
    public async archiveStaticVoucherCampaign (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StaticVoucherCampaign;  }> {
    ...
    /**
     * 
     * @summary Count vouchers in Static Vouchers Campaign
     * @param campaignID 
     */
    public async countVouchersLoaded (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchMembersCount200Response;  }> {
    ...
    /**
     * 
     * @summary Count redeemed vouchers in Static Vouchers Campaign
     * @param campaignID 
     */
    public async countVouchersRedeemed (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchMembersCount200Response;  }> {
    ...
    /**
     * 
     * @summary Create Static Voucher Campaign with single voucher
     * @param body 
     */
    public async createStaticVoucherCampaignWithVoucher (body: PickCreateStaticVoucherCampaignWithVoucherExcludeKeyofcreateStaticVoucherCampaignWithVoucherIsActive, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTStaticVoucherCampaign;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PickCreateStaticVoucherCampaignWithVoucherExcludeKeyofcreateStaticVoucherCampaignWithVoucherIsActive")
        };
    ...
    /**
     * 
     * @summary Duplicate Static Vouchers Campaign
     * @param campaignID 
     */
    public async duplicateStaticVoucherCampaignById (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTStaticVoucherCampaign;  }> {
    ...
    /**
     * 
     * @summary Get Static Voucher Campaign performance overview
     * @param campaignID 
     */
    public async fetchPerformanceOverview (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
    ...
    /**
     * 
     * @summary Get the reach statistics of all Static Voucher Campaigns
    ...
    /**
     * 
     * @summary Get the reach statistics of a single Static Voucher Campaign
     * @param staticVoucherCampaignID 
     * @param broadcastScheduledStartAt 
     * @param broadcastScheduledEndAt 
     */
    public async fetchReachStatsOfIndividualStaticVoucherCampaign (staticVoucherCampaignID: string, broadcastScheduledStartAt?: Date, broadcastScheduledEndAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReachPerformanceStats;  }> {
    ...
    /**
     * 
     * @summary Get Static Vouchers Campaign
     * @param id 
     */
    public async fetchStaticVoucherCampaignById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTStaticVoucherCampaign;  }> {
    ...
    /**
     * 
     * @summary Get all Static Vouchers Campaigns
    ...
    /**
     * 
     * @summary Get vouchers in Static Vouchers Campaign
     * @param campaignID 
     */
    public async fetchStaticVouchers (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<WTStaticVoucher>;  }> {
    ...
    /**
     * 
     * @summary Get a page of vouchers in a Static Voucher Campaign
     * @param campaignID 
     * @param pagenum 
     * @param pagesize 
     */
    public async fetchStaticVouchersPage (campaignID: string, pagenum: number, pagesize: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchStaticVouchersPage200Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FetchStaticVouchersPage200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FetchStaticVouchersPage200Response");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    /**
     * 
     * @summary Get Static Vouchers Campaign traffic
     * @param campaignID 
     */
    public async fetchViews (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<WTWalletPageView>;  }> {
    ...
    /**
     * 
     * @summary Get redeemed vouchers in Static Vouchers Campaign
     * @param campaignID 
     */
    public async fetchVouchersRedeemed (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<WTStaticVoucher>;  }> {
    ...
    /**
     * 
     * @summary Preview generated broadcast messages by page
     * @param campaignID 
     * @param wTStaticVoucherCampaignPreviewMessagesByPage 
     */
    public async previewMessagesByPage (campaignID: string, wTStaticVoucherCampaignPreviewMessagesByPage: WTStaticVoucherCampaignPreviewMessagesByPage, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VSCampaignGeneratedMessagePagination;  }> {
     ...
     * @param campaignID 
     */
    public async restoreStaticVoucherCampaign (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StaticVoucherCampaign;  }> {
        const localVarPath = this.basePath + '/v2/payment/staticVoucherCampaign/{campaignID}'
            .replace('{' + 'campaignID' + '}', encodeURIComponent(String(campaignID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async updateStaticVoucherCampaign (campaignID: string, staticVoucherCampaignUpdate: StaticVoucherCampaignUpdate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTStaticVoucherCampaign;  }> {
        const localVarPath = this.basePath + '/v2/payment/staticVoucherCampaign/{campaignID}'
            .replace('{' + 'campaignID' + '}', encodeURIComponent(String(campaignID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    /**
     * 
     * @summary Update Static Voucher Campaign with single voucher
     * @param campaignID 
     * @param updateStaticVoucherCampaignWithVoucher 
     */
    public async updateStaticVoucherCampaignWithVoucher (campaignID: string, updateStaticVoucherCampaignWithVoucher: UpdateStaticVoucherCampaignWithVoucher, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTStaticVoucherCampaign;  }> {
