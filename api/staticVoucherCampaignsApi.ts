...
export class StaticVoucherCampaignsApi {
     ...
     * @param campaignID 
     */
    public async countVouchersLoaded (campaignID: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchMembersCount200Response;  }> {
     ...
     * @param campaignID 
     */
    public async countVouchersRedeemed (campaignID: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchMembersCount200Response;  }> {
     ...
     * @param pagesize 
     */
    public async fetchStaticVouchersPage (campaignID: any, pagenum: number, pagesize: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchStaticVouchersPage200Response;  }> {
