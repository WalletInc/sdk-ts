...
export enum WixTerminalApiApiKeys {
    api_key,
}

export class WixTerminalApi {
    ...
    public setApiKey(key: WixTerminalApiApiKeys, value: string) {
        (this.authentications as any)[WixTerminalApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param itemID 
     */
    public async fetchWalletItemFromWixTerminal (itemID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
     ...
     */
    public async redeemWalletItemFromWixTerminal (itemID: string, wTWalletItemRedemption: WTWalletItemRedemption, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
     ...
     * @param ledgerEntryID 
     */
    public async refundWalletItemFromWixTerminal (ledgerEntryID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
