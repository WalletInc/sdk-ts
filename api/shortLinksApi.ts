...
export enum ShortLinksApiApiKeys {
    api_key,
}
...
export class ShortLinksApi {
    ...
    public setApiKey(key: ShortLinksApiApiKeys, value: string) {
        (this.authentications as any)[ShortLinksApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * 
     * @summary Archive Short Link
     * @param id 
     */
    public async archiveMerchantURL (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MerchantURL;  }> {
     ...
     * @param id 
     */
    public async fetchMerchantURL (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MerchantURL;  }> {
        const localVarPath = this.basePath + '/v2/business/merchantUrl/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    /**
     * 
     * @summary Get Short Link traffic
     * @param id 
     */
    public async fetchMerchantURLRequests (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<WalletPageView>;  }> {
    ...
    /**
     * 
     * @summary Get Short Link traffic (paginated)
     * @param id 
     * @param page 
     * @param limit 
     */
    public async fetchMerchantURLRequestsPaged (id: string, page?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchMerchantURLRequestsPaged200Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FetchMerchantURLRequestsPaged200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FetchMerchantURLRequestsPaged200Response");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    /**
     * 
     * @summary Restore Short Link
     * @param id 
     */
    public async restoreMerchantURL (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MerchantURL;  }> {
        const localVarPath = this.basePath + '/v2/business/merchantUrl/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async updateMerchantURL (id: string, wTMerchantURLUpdate: WTMerchantURLUpdate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MerchantURL;  }> {
        const localVarPath = this.basePath + '/v2/business/merchantUrl/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
