...
export class EmployeesApi {
    ...
    /**
     * 
     * @summary Sets the employee\'s admin-portal chrome theme (light/dark), synced across devices (KAN-846)
     * @param updateChromeThemePreferenceRequest 
     */
    public async updateChromeThemePreference (updateChromeThemePreferenceRequest: UpdateChromeThemePreferenceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Employee;  }> {
        ...
        // verify required parameter 'updateChromeThemePreferenceRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateChromeThemePreferenceRequest, "UpdateChromeThemePreferenceRequest")
        };
    ...
    /**
     * 
     * @summary Turns the admin-portal page tips bar on or off for this employee, synced across devices (KAN-963)
     * @param updatePageTipsPreferenceRequest 
     */
    public async updatePageTipsPreference (updatePageTipsPreferenceRequest: UpdatePageTipsPreferenceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Employee;  }> {
        ...
        // verify required parameter 'updatePageTipsPreferenceRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updatePageTipsPreferenceRequest, "UpdatePageTipsPreferenceRequest")
        };
