...
export class EmployeesApi {
     ...
     * @param inlineObject 
     */
    public async updateEmailNotificationPreference (inlineObject: InlineObject, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Employee;  }> {
