...
export enum EmployeeAccessApiApiKeys {
    api_key,
}

export class EmployeeAccessApi {
    ...
    public setApiKey(key: EmployeeAccessApiApiKeys, value: string) {
        (this.authentications as any)[EmployeeAccessApiApiKeys[key]].apiKey = value;
    }
