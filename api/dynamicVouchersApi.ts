...
export class DynamicVouchersApi {
     ...
     * @param campaignID 
     */
    public async archiveDynamicVoucherCampaign (campaignID: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DynamicVoucher;  }> {
     ...
     * @param campaignID 
     */
    public async restoreDynamicVoucherCampaign (campaignID: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DynamicVoucher;  }> {
        const localVarPath = this.basePath + '/v2/payment/dynamicVoucher/{campaignID}'
            .replace('{' + 'campaignID' + '}', encodeURIComponent(String(campaignID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
