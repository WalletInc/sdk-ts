...
export class DynamicVouchersApi {
    ...
    /**
     * 
     * @summary Archive Dynamic Voucher Campaign
     * @param campaignID 
     */
    public async archiveDynamicVoucherCampaign (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DynamicVoucher;  }> {
    ...
    /**
     * 
     * @summary Create Dynamic Voucher Campaign
    ...
    /**
     * 
     * @summary Get all Dynamic Voucher Campaigns
    ...
    /**
     * 
     * @summary Get Dynamic Voucher Campaign
     * @param id 
     */
    public async fetchDynamicVoucherById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTDynamicVoucher;  }> {
    ...
    /**
     * 
     * @summary Get Dynamic Voucher Campaign Redemptions
     * @param id 
     */
    public async fetchDynamicVoucherRedemptions (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<WTDynamicVoucherRedemption>;  }> {
     ...
     * @param broadcastScheduledEndAt 
     */
    public async fetchReachStatsOfIndividualDynamicVoucher (dynamicVoucherID: string, broadcastScheduledStartAt?: Date, broadcastScheduledEndAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReachPerformanceStats;  }> {
    ...
    /**
     * 
     * @summary Restore Dynamic Voucher Campaign
     * @param campaignID 
     */
    public async restoreDynamicVoucherCampaign (campaignID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DynamicVoucher;  }> {
        const localVarPath = this.basePath + '/v2/payment/dynamicVoucher/{campaignID}'
            .replace('{' + 'campaignID' + '}', encodeURIComponent(String(campaignID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    /**
     * 
     * @summary Update Dynamic Voucher Campaign
     * @param id 
     * @param wTDynamicVoucherUpdateParams 
     */
    public async saveDynamicVoucher (id: string, wTDynamicVoucherUpdateParams: WTDynamicVoucherUpdateParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTDynamicVoucher;  }> {
        const localVarPath = this.basePath + '/v2/payment/dynamicVoucher/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
