...
export class CustomerApi {
    ...
    /**
     * 
     * @summary Get active static vouchers
     * @param memberID 
    ...
    /**
     * 
     * @summary Get all static vouchers
     * @param memberID 
     * @param cellPhoneNumber 
     */
    ...
    public async fetchCustomerByChatIdentity (chatUserID: string, identityOnly?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        ...
        // verify required parameter 'chatUserID' is not null or undefined
        ...
        if (identityOnly !== undefined) {
            localVarQueryParameters['identityOnly'] = ObjectSerializer.serialize(identityOnly, "boolean");
        }
    ...
    /**
     * 
     * @summary Get expired static vouchers
     * @param memberID 
     * @param cellPhoneNumber 
     */
    ...
    /**
     * 
     * @summary Get upcoming static vouchers
     * @param memberID 
     * @param cellPhoneNumber 
     */
    ...
    /**
     * 
     * @summary Get Wallet Views for Session
     * @param id 
     */
