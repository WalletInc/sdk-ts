...
export class MerchantCreditsApi {
     ...
     * @param id 
     */
    public async archiveMerchantCredit (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTMerchantCredit;  }> {
    ...
    /**
     * 
     * @summary Get Merchant Credit
     * @param id 
     */
    public async fetchMerchantCreditById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTMerchantCredit;  }> {
        const localVarPath = this.basePath + '/v2/payment/merchantcredit/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    /**
     * 
     * @summary Count all Merchant Credits
     */
    public async fetchMerchantCreditCount (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchMembersCount200Response;  }> {
     ...
     * @param id 
     */
    public async restoreMerchantCredit (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTMerchantCredit;  }> {
        const localVarPath = this.basePath + '/v2/payment/merchantcredit/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    /**
     * 
     * @summary Search for Merchant Credits with Member ID
     ...
     */
    public async updateMerchantCredit (id: string, pickWTMerchantCreditMemberIDOrCreditAmountOrMobileNumber: PickWTMerchantCreditMemberIDOrCreditAmountOrMobileNumber, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTMerchantCredit;  }> {
        const localVarPath = this.basePath + '/v2/payment/merchantcredit/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
