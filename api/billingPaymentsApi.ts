...
export enum BillingPaymentsApiApiKeys {
    api_key,
}
...
export class BillingPaymentsApi {
    ...
    public setApiKey(key: BillingPaymentsApiApiKeys, value: string) {
        (this.authentications as any)[BillingPaymentsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createBillingPortalSession (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
     ...
     */
    public async fetchCustomerPaymentMethods (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
    ...
    /**
     * 
     * @summary Get merchant\'s industry
     */
    public async fetchIndustry (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchIndustry200Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FetchIndustry200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FetchIndustry200Response");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    /**
     * 
     * @summary Run a consumer-authorized financing soft credit inquiry (LeadFi, tri-bureau) Consumer-initiated FCRA permissible purpose: the authenticated user explicitly authorizes the check (disclosure text is submitted verbatim and persisted as evidence). The consent IP is captured server-side from the request; the inquiry is refused when it cannot be captured. Fails fast until LeadFi credentials are provisioned (go-live gated on counsel sign-off).
     * @param wTFinancingSoftPullRequest 
     */
    public async runFinancingSoftPull (wTFinancingSoftPullRequest: WTFinancingSoftPullRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTFinancingSoftPullResponse;  }> {
        ...
        // verify required parameter 'wTFinancingSoftPullRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(wTFinancingSoftPullRequest, "WTFinancingSoftPullRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WTFinancingSoftPullResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "WTFinancingSoftPullResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param setDefaultPaymentMethodRequest 
     */
    public async setDefaultPaymentMethod (setDefaultPaymentMethodRequest: SetDefaultPaymentMethodRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Merchant;  }> {
        ...
        // verify required parameter 'setDefaultPaymentMethodRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(setDefaultPaymentMethodRequest, "SetDefaultPaymentMethodRequest")
        };
    ...
    /**
     * 
     * @summary Set merchant\'s industry
     * @param wTBillingSetIndustry 
     */
    public async setIndustry (wTBillingSetIndustry: WTBillingSetIndustry, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FetchIndustry200ResponseAnyOf;  }> {
        const localVarPath = this.basePath + '/v2/billing/industry';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'wTBillingSetIndustry' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(wTBillingSetIndustry, "WTBillingSetIndustry")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FetchIndustry200ResponseAnyOf;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FetchIndustry200ResponseAnyOf");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
