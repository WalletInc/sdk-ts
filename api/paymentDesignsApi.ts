...
export class PaymentDesignsApi {
     ...
     * @param id 
     */
    public async archivePaymentDesign (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTPaymentDesign;  }> {
    ...
    /**
     * 
     * @summary Get all payment designs
    ...
    /**
     * 
     * @summary Get payment design
     * @param id 
     */
    public async fetchPaymentDesignById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTPaymentDesign;  }> {
        const localVarPath = this.basePath + '/v2/payment/design/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param id 
     */
    public async restorePaymentDesign (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTPaymentDesign;  }> {
        const localVarPath = this.basePath + '/v2/payment/design/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async updatePaymentDesign (id: string, wTPaymentDesignUpdateParams: WTPaymentDesignUpdateParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTPaymentDesign;  }> {
        const localVarPath = this.basePath + '/v2/payment/design/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
