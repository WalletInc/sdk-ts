...
export class InteractionsApi {
     ...
     */
    public async claimTicket (id: string, claimTicketRequest: ClaimTicketRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Ticket;  }> {
        ...
        // verify required parameter 'claimTicketRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(claimTicketRequest, "ClaimTicketRequest")
        };
     ...
     * @param adCreditID 
     */
    public async createAdvertisementCreditScan (adCreditID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AdvertisementCreditScan;  }> {
    ...
    /**
     * 
     * @summary Download a representative\'s Virtual Business Card
     * @param id 
     */
    public async createEmployeeVCard (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
    ...
    /**
     * 
     * @summary Create a guest tip / donation PaymentIntent (KAN-861)
     * @param wTGuestDonationRequest 
     */
    public async createGuestDonation (wTGuestDonationRequest: WTGuestDonationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTGuestCreatePaymentIntentResponse;  }> {
        ...
        // verify required parameter 'wTGuestDonationRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(wTGuestDonationRequest, "WTGuestDonationRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WTGuestCreatePaymentIntentResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "WTGuestCreatePaymentIntentResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    /**
     * 
     * @summary Create a guest checkout PaymentIntent (KAN-802)
     * @param wTGuestCreatePaymentIntentRequest 
     */
    public async createGuestPaymentIntent (wTGuestCreatePaymentIntentRequest: WTGuestCreatePaymentIntentRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTGuestCreatePaymentIntentResponse;  }> {
        ...
        // verify required parameter 'wTGuestCreatePaymentIntentRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(wTGuestCreatePaymentIntentRequest, "WTGuestCreatePaymentIntentRequest")
        };
    ...
    /**
     * 
     * @summary Get ICS for live event
     * @param id 
     */
    public async createIcsFile (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
    ...
    /**
     * 
     * @summary Download a non-representative\'s Virtual Business Card
     * @param id 
     */
    public async createVirtualBusinessCardVCard (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
    ...
    /**
     * 
     * @summary Get multiple credit scans w/ array of IDs
     * @param merchantID 
     * @param fetchAdvertisementCreditScansFromListRequest 
     */
    public async fetchAdvertisementCreditScansFromList (merchantID: string, fetchAdvertisementCreditScansFromListRequest: FetchAdvertisementCreditScansFromListRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<any>;  }> {
        ...
        // verify required parameter 'fetchAdvertisementCreditScansFromListRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(fetchAdvertisementCreditScansFromListRequest, "FetchAdvertisementCreditScansFromListRequest")
        };
     ...
     * @param voucherID 
     */
    public async fetchAllStaticVouchersAssociatedWithCustomerWithVoucherID (voucherID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<FetchAllStaticVouchersAssociatedWithCustomerWithVoucherID200ResponseInner>;  }> {
        ...
        if (voucherID !== undefined) {
            localVarQueryParameters['voucherID'] = ObjectSerializer.serialize(voucherID, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<FetchAllStaticVouchersAssociatedWithCustomerWithVoucherID200ResponseInner>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<FetchAllStaticVouchersAssociatedWithCustomerWithVoucherID200ResponseInner>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    public async fetchCustomerTicketsWithToken (fetchCustomerTicketsWithTokenRequest: FetchCustomerTicketsWithTokenRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Ticket>;  }> {
        ...
        // verify required parameter 'fetchCustomerTicketsWithTokenRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(fetchCustomerTicketsWithTokenRequest, "FetchCustomerTicketsWithTokenRequest")
        };
    ...
    /**
     * 
     * @summary Get dynamic voucher
     * @param voucherID 
     */
    public async fetchDynamicVoucherWithVoucherID (voucherID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DynamicVoucher;  }> {
    ...
    /**
     * 
     * @summary Fetch a guest order receipt (KAN-802)
     * @param id 
     * @param phoneVerificationToken 
     */
    public async fetchGuestOrder (id: string, phoneVerificationToken: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WTGuestOrderReceipt;  }> {
        ...
        // verify required parameter 'phoneVerificationToken' is not null or undefined
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WTGuestOrderReceipt;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "WTGuestOrderReceipt");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    /**
     * 
     * @summary Get static voucher
     * @param voucherID 
     */
    public async fetchStaticVoucherWithVoucherID (voucherID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StaticVoucher;  }> {
    ...
    /**
     * 
     * @summary Request Merchant URL
     * @param itemID 
     * @param browserDetails 
     */
    public async requestMerchantURLRedirect (itemID: string, browserDetails: BrowserDetails, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        ...
        // verify required parameter 'browserDetails' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(browserDetails, "BrowserDetails")
        };
     ...
     * @param wTSmsSubscriberCreateParamsWalletUI 
     */
    public async subscribeSms (wTSmsSubscriberCreateParamsWalletUI: WTSmsSubscriberCreateParamsWalletUI, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SmsSubscriber;  }> {
        ...
        // verify required parameter 'wTSmsSubscriberCreateParamsWalletUI' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(wTSmsSubscriberCreateParamsWalletUI, "WTSmsSubscriberCreateParamsWalletUI")
        };
