...
export class InteractionsApi {
     ...
     */
    public async claimTicket (id: any, claimTicketRequest: ClaimTicketRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Ticket;  }> {
     ...
     * @param id 
     */
    public async createVirtualBusinessCardVCard (id: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     * @param voucherID 
     */
    public async fetchAllStaticVouchersAssociatedWithCustomerWithVoucherID (voucherID: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<FetchAllStaticVouchersAssociatedWithCustomerWithVoucherID200ResponseInner>;  }> {
